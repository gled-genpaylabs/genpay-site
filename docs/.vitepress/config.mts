...
const parser = JSON.parse(
  fs.readFileSync(resolve(__dirname, "genpay.tmLanguage.json"), "utf8"),
);

const genpayLang: ILanguageRegistration = {
  id: "genpay",
  aliases: ["genpay", "genpay"],
  scopeName: "source.genpay",
  path: resolve(__dirname, "genpay.tmLanguage.json"),
  ...parser,
};

// https://vitepress.dev/reference/site-config
export default defineConfig({
  title: "Genpay Language",
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: "github", link: "https://github.com/gled-genpaylabs/genpay" },
    ],
  },
  markdown: {
    languages: [genpayLang],
    theme: {
      light: "github-light",
      dark: "github-dark",
    },
